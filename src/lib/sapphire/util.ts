...
import { type APIUser, type Channel, ChannelType, type Guild, GuildChannel, InteractionType, ThreadChannel, type User } from 'discord.js'

export const tracer = trace.getTracer('@sapphire/framework')
export const meter = metrics.getMeter('@sapphire/framework')
...
export function formatChannelType(type: ChannelType): string {
  switch (type) {
    ...
    case ChannelType.GuildMedia:
      return 'guild.media'
    default:
      throw new Error('Unknown ChannelType')
  }
}
